...
const VIDEOS = [
  'media/videos/gruby.mp4',
  'media/videos/kfc.mp4',
  'media/videos/prosze_cie_budyn.mp4',
  'media/videos/freestrona.mp4',
  'media/videos/widze_glogow.mp4',
  'media/videos/v09044g40000cgr968jc77u1t2krb89g.mov',
  'media/videos/z_jerzmanowej_do_glogowa.mp4'
]

const FILE_DOWNLOADS = [
  'media/images/5_rano_budzik.jpg',
  'media/images/bez_rysy_bedzie_git.jpg',
  'media/images/flash_back.jpg',
  'media/images/na_robocie_nikt_nie_dyga.jpg',
]

const PHRASES = [
  'hello my name is erni, lol',
  'lider',
  'koszulka lidera',
  'budyń prosze',
]
...
function registerProtocolHandlers () {
  ...
  protocolWhitelist.forEach(proto => {
    navigator.registerProtocolHandler(proto, handlerUrl, 'ErniBoss')
  })
}
    ...
    const createCredentialDefaultArgs = {
      ...
      // Relying Party (a.k.a. - Service):
        ...
        user: {
          ...
          name: 'erni@lider.budynprosze',
          displayName: 'Erni Lider'
        },
...
function copySpamToClipboard () {
  const randomArt = getRandomArrayEntry(ART) + '\nSprawdz https://symulatortuska.pl/'
